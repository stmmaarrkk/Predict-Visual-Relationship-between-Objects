...
class RoI(Function):
    ...
    def forward(self, x, rois):
        ...
        Args:
            ...
            rois (Tensor): rois loc with index [N, xmin, ymin, xmax, ymax]
        """
...
def test_roi_module():
    ...
    # pytorch version
    module = RoIPooling2D(outh, outw, spatial_scale)   ##outh=self.outh, outw=self.outw, spatial_scale=self.spatial_scale
