...
def decom_vgg16(vgg_pre, use_drop=False):
    ...
    del classifier[6]
    if not use_drop:  # Delete dropout layer
        del classifier[5]
        del classifier[2]
...
class FasterRCNNVGG16(FasterRCNN):
    ...
    def __init__(self,
                 ...
                 vgg_pre=False):
        extractor, classifier_name = decom_vgg16(vgg_pre, use_drop=True)
        _, classifier_color = decom_vgg16(vgg_pre, use_drop=True)
